...
{{ include "proxy-pool.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "proxy-pool.selectorLabels" -}}
...
*/}}
{{- define "proxy-pool.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "proxy-pool.fullname" .) .Values.serviceAccount.name }}
{{- else }}
